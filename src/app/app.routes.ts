...
export const routes: Routes = [
  ...
  { path: 'privacy', loadComponent: () => import('../modules/privacy/privacy.component').then(m => m.PrivacyComponent) },
  { path: 'terms', loadComponent: () => import('../modules/terms/terms.component').then(m => m.TermsComponent) },
  {
    path: '',
